...
<body class="nav-md">
  <div class="container body">
    <div class="main_container">
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="/gentelella/project/index.html" class="site_title">
              <i class="fa fa-paw"></i>
              <span>...</span>
            </a>
          </div>
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="/gentelella/project/images/img.jpg" alt="." class="img-circle profile_img">
            </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li>
                  <a>
                    <i class="fa fa-sitemap"></i> Materiais
                    <span class="fa fa-chevron-down"></span>
                  </a>
                  <ul class="nav child_menu">
                    <li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="/gentelella/project/images/img.jpg" alt="">John Doe
              ...
              <li role="presentation" class="dropdown">
                ...
                <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                  <li>
                    <a>
                      <span class="image">
                        <img src="/gentelella/project/images/img.jpg" alt="Profile Image" />
                      </span>
                      <span>
      ...
      <!-- page content -->
      <div id="content" name="content" class="right_col" role="main">
  ...
  <script src="/gentelella/project/js/index.js"></script>
</body>
