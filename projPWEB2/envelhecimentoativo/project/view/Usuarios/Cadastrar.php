         ...
         <div class="x_panel">
            ...
            <div class="x_content">
               ...
               <div class="col-md-8 col-sm-12 col-xs-8">
                  <form id="frmCadUsuario" method="POST" action="/envelhecimentoativo/project/controller/recebeUsuario.php?act=salvar" data-parsley-validate class="form-horizontal justify-content-center">
